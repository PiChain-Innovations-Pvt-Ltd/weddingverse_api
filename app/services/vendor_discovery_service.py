...
# weddingverse_api15/app/services/vendor_discovery_service.py
import math
import hashlib
...
def get_vendors_for_category(
    ...
    try:
        ...
        # --- IMPORTANT FIX: Stable Sorting for Pagination ---
        ...
        # 3. `vendor.vendor_id`: This is the crucial tie-breaker. Since vendor_id is unique and deterministic,
        ...
        # It doesn't need to be part of the production endpoint's return.
        if len(paginated_vendors) > 0:
            ...
            # To check repetition between pages (conceptually):
            # You would need to store/compare sets of vendor_ids from previous pages.
            # E.g., if you fetched page 1 and page 2, you could do:
            # set_page1_ids = {v.vendor_id for v in vendors_list[0:10]}
            # set_page2_ids = {v.vendor_id for v in vendors_list[10:20]}
            # overlap = set_page1_ids.intersection(set_page2_ids)
            # if overlap: logger.error(f"OVERLAP DETECTED BETWEEN PAGES: {overlap}")
